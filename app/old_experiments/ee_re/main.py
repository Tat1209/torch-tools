...
train_ds_str_l = ["cifar10_train", "cifar100_train", "stl10_train", "cars_train", "pets_train"]
val_ds_str_l = ["cifar10_val", "cifar100_val", "stl10_val", "cars_val", "pets_val"]
...
for train_ds_str, val_ds_str in zip(train_ds_str_l, val_ds_str_l):
    for fils_l in [[2 ** i for i in range(int(math.log2(base_fils)) + 1)]]:
        ...
        print(f"{base_fils=}, {fils_l}, {batch_size=}")
