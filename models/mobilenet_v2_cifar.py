    ...
    def __init__(
        ...
        if inverted_residual_setting is None:
            inverted_residual_setting = [
                # t, c, n, s
                [1, 16, 1, 1],
                [6, 24, 2, 1], # Edited for cifar. default: [6, 24, 2, 2]
                [6, 32, 3, 2],
                [6, 64, 4, 2],
                [6, 96, 3, 1],
                [6, 160, 3, 2],
        ...
        features: List[nn.Module] = [
            Conv2dNormActivation(3, input_channel, stride=1, norm_layer=norm_layer, activation_layer=nn.ReLU6) # Edited for cifar. default: stride=2
        ]
