...
for max_lrs in [[0.0005]]:
    ...
    train_trans = [transforms.ToTensor(), transforms.Grayscale(num_output_channels=1), transforms.RandomHorizontalFlip(p=0.5), transforms.RandomRotation(degrees=(0, 360))]
    val_trans = [transforms.ToTensor(), transforms.Resize((32, 32), antialias=True)]
