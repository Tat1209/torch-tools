...
class Trainer(TrainerUtils):
    ...
    def torchinfo(self,
        ...
        sys.stdout = buf
        summary(model=self.network, input_size=input_size, batch_dim=batch_dim, depth=depth, verbose=verbose, col_names=col_names, row_settings=row_settings)
...
class MergeEnsemble(TrainerUtils):
    def __init__(self, trainers, loss_func=None, optimizer=None, scheduler_t=(None, None), device=None):
        super().__init__(device)
        self.trainers = trainers
        self.loss_func = loss_func
        self.optimizer = optimizer
    ...
    # def __init__(self, trainers=None, device=None): ################################################### has bug
    #     super().__init__(device)
    #     self.trainers = trainers
